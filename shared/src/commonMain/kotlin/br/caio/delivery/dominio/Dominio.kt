...
@JvmInline
value class RestaurantId(val value: Uuid) {
    companion object {
...
value class Dinheiro(val centavos: Long) {
    ...
    companion object {
        fun deReais(reais: Long, centavos: Long = 0): Dinheiro =
...
data class Restaurant(
    ...
    fun atualizarDisponibilidade(id: MenuItemId, disponivel: Boolean): Restaurant {
        val novaLista = itens.map {
